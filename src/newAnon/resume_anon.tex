...
\resumeSubHeadingListStart
  ...
  \resumeItemListStart
    ...
    \resumeItem{Displays user's recent transactions using Plaid API in a full-stack app with Next.js and Supabase}
    \resumeItem{Enables users to upload images of receipts which are processed by Azure AI Vision and GPT-3.5}
    \resumeItem{}
    \resumeItemListEnd
