...
\begin{center}
    ...
    \href{mailto:da303419@ucf.edu}{\underline{da303419@ucf.edu}} $|$ \href{mailto:dany@dpalma.dev}{\underline{dany@dpalma.dev}} $|$ 
...
%-------------------------------------------
    ...
    \resumeSubheading
      {Developer}{August 2022 - Present}
      {Knight Hacks}{Orlando, FL}
      \resumeItemListStart
        \resumeItem{ Aided in development of yearly Hackathon website and Admin Tool using Next.js }
        \resumeItem{ Integrated Tailwind CSS to create an aesthetically pleasing User Interface. }
    \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Collaborated with other Peer Tutors to hold weekly review sessions.}
        \resumeItem{Provided students with resources in order to properly identify and solve problems.}
        \resumeItem{Demonstrated how to implement complex data structures and algorithms into functional programs.}
      \resumeItemListEnd
